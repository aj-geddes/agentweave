...
- [Identity & SPIFFE](identity/): How agents get cryptographic identity
- [Authorization & OPA](authorization/): How agents enforce access control
- [A2A Protocol](communication/): How agents communicate with each other
