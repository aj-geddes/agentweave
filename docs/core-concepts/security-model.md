...
- [System Architecture](architecture/): See how security layers fit into the overall architecture
- [Identity & SPIFFE](identity/): Deep dive into Layer 1 (Identity)
- [Authorization & OPA](authorization/): Deep dive into Layer 3 (Authorization)
- [A2A Protocol](communication/): How security is enforced during agent calls
